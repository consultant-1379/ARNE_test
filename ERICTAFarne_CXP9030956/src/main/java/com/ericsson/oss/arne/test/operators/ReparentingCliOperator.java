...
public class ReparentingCliOperator extends CLIOperator implements ReparentingOperator {

private static Logger logger = Logger.getLogger( ReparentingCliOperator.class);
	
	@Override
	public int executeCommand (String reparentXML) {
		...
		String command = getCommand(reparentXML);
	...
	public int executeTearDown (String DeleteXML) {
    ...
    public Map<String, String> get(String step) {
        return loadData("Reparenting_CliTestData.csv", step);
    }
